...
1. Upload video: open YouTube Studio → Create → Upload → select `videos\scopeai-xprize-demo\renders\scopeai-xprize-demo_2026-08-17_15-35-00.mp4` → title "ScopeAI — Autonomous Competitive Intelligence (XPRIZE)" → Public → Publish
